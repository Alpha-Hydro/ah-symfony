...
function search(searchQueryElementId) {
	if (searchQueryElementId) {
		(0, _jquery2.default)(document).on('keyup', searchQueryElementId, function (e) {
			e.preventDefault();
			e.stopPropagation();
...
jQuery.offset = {
	setOffset: function( elem, options, i ) {
		...
		if ( jQuery.isFunction( options ) ) {
			...
			// Use jQuery.extend here to allow subproduct of coordinates argument (gh-1848)
