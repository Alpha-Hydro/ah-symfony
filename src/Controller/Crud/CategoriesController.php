...
class CategoriesController extends Controller
{
    ...
    {
        return $this->render('admin/catalog/index.html.twig', ['categories' => $categoriesRepository->findByRootCategories()]);
    }
    ...
    /**
     * @Route("/{id}/products", name="categories_products_list", methods="GET")
     * @param Categories $category
     * @return Response
     */
    public function productList(Categories $category): Response
    {
        $data = [
            'category' => $category,
        ];

        return $this->render('admin/catalog/products_list.html.twig', $data);
    }
